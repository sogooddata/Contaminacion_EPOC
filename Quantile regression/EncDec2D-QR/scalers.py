...
# -*- coding: utf-8 -*-
"""
Created on Fri Mar 27 08:45:16 2020
            ...
            if self.is_scaled:
                if not self.by_point:
                    if data.dim() == 3:
                        ...
                        # N,C,T,S format
                        # Se eligen los C primeros canales, pensando en que al revertir la escala
                        # probablemente ya solo te quedes con el primero (la serie) y no con las
                        #  variables exógenas.
                        N,C,T,S = data.size()
                ...
                # Este tiene sentido a medias, porque puedes usar otros datos como el test y el val
